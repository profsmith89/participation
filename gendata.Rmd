...
dataDSR <- read_xlsx(here::here("data","MikeDSR_analysis_Deniz.xlsx") )
...
dataDSR_2 <- read_xlsx(here::here("data","MikeDSR_analysis_Deniz_2.xlsx"),sheet = "Iteration_1 (2)" ) # the data that included discussion number (via vlookup)
#clean names
